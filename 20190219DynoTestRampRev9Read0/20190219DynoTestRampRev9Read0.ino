...
{
  for(ThrottlePercent = 0 ; ThrottlePercent < 20; ThrottlePercent +=1) //Ramp input from 0 to 50% in 2 seconds
  {
...
{
  for(ThrottlePercent = 20 ; ThrottlePercent > 0; ThrottlePercent -=1) //Ramp input from 0 to 50% in 2 seconds
  {
    FirstTensVariable = ThrottlePercent; //Store the 0-100 value read from the potentiometer e.g. 58.67%
TensCharacter = (FirstTensVariable/10); //Stroe the tens multiplier e.g. 5
