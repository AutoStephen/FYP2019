...
if (ThrottlePercent > 22.00 && ThrottlePercent <= 30.00) {
  //Serial.println("s");
  mySerial.println("3f"); //Turn the motor at 20% when switched to software pins.
  Serial.println("0"); //Turn the motor off when the shield is looking at hardware pins.
}
if (ThrottlePercent > 32.00 && ThrottlePercent <= 40.00) {
  //Serial.println("s");
  mySerial.println("4f"); //Turn the motor at 20% when switched to software pins.
  Serial.println("0"); //Turn the motor off when the shield is looking at hardware pins.
}
if (ThrottlePercent > 42.00 && ThrottlePercent <= 50.00) {
  //Serial.println("s");
  mySerial.println("5f"); //Turn the motor at 20% when switched to software pins.
  Serial.println("0"); //Turn the motor off when the shield is looking at hardware pins.
}
if (ThrottlePercent > 52.00 && ThrottlePercent <= 60.00) {
  //Serial.println("s");
  mySerial.println("6f"); //Turn the motor at 20% when switched to software pins.
  Serial.println("0"); //Turn the motor off when the shield is looking at hardware pins.
}
if (ThrottlePercent > 62.00 && ThrottlePercent <= 70.00) {
  //Serial.println("s");
  mySerial.println("7f"); //Turn the motor at 20% when switched to software pins.
  Serial.println("0"); //Turn the motor off when the shield is looking at hardware pins.
}
if (ThrottlePercent > 72.00 && ThrottlePercent <= 80.00) {
  //Serial.println("s");
  mySerial.println("8f"); //Turn the motor at 20% when switched to software pins.
  Serial.println("0"); //Turn the motor off when the shield is looking at hardware pins.
}
if (ThrottlePercent > 82.00 && ThrottlePercent <= 90.00) {
  //Serial.println("s");
  mySerial.println("9f"); //Turn the motor at 20% when switched to software pins.
  Serial.println("0"); //Turn the motor off when the shield is looking at hardware pins.
}
if (ThrottlePercent > 92.00 && ThrottlePercent <= 100.00) {
  //Serial.println("s");
  mySerial.println("mf"); //Turn the motor at 20% when switched to software pins.
  Serial.println("0"); //Turn the motor off when the shield is looking at hardware pins.
}
