...
if (ThrottlePercent > 0.00 && ThrottlePercent <= 10.00) {
  mySerial.print("1f"); //Turn the motor at 10% when switched to hardware pins.
  mySerial.print("s"); //Ensure controller is in Serial Mode
}
if (ThrottlePercent > 10.00 && ThrottlePercent <= 20.00) {
  mySerial.print("2f"); //Turn the motor at 20% when switched to hardware pins.
  mySerial.print("s"); //Ensure controller is in Serial Mode
}
if (ThrottlePercent > 20.00 && ThrottlePercent <= 30.00) {
  mySerial.print("3f"); //Turn the motor at 30% when switched to hardware pins.
  mySerial.print("s"); //Ensure controller is in Serial Mode
}
if (ThrottlePercent > 30.00 && ThrottlePercent <= 40.00) {
  mySerial.print("4f"); //Turn the motor at 40% when switched to hardware pins.
  mySerial.print("s"); //Ensure controller is in Serial Mode
}
if (ThrottlePercent > 40.00 && ThrottlePercent <= 50.00) {
  mySerial.print("5f"); //Turn the motor at 50% when switched to hardware pins.
  mySerial.print("s"); //Ensure controller is in Serial Mode
}
if (ThrottlePercent > 50.00 && ThrottlePercent <= 60.00) {
  mySerial.print("6f"); //Turn the motor at 60% when switched to hardware pins.
  mySerial.print("s"); //Ensure controller is in Serial Mode
}
if (ThrottlePercent > 60.00 && ThrottlePercent <= 70.00) {
  mySerial.print("7f"); //Turn the motor at 70% when switched to hardware pins.
  mySerial.print("s"); //Ensure controller is in Serial Mode
}
if (ThrottlePercent > 70.00 && ThrottlePercent <= 80.00) {
  mySerial.print("8f"); //Turn the motor at 80% when switched to hardware pins.
  mySerial.print("s"); //Ensure controller is in Serial Mode
}
if (ThrottlePercent > 80.00 && ThrottlePercent <= 90.00) {
  mySerial.print("9f"); //Turn the motor at 90% when switched to hardware pins.
  mySerial.print("s"); //Ensure controller is in Serial Mode
}
