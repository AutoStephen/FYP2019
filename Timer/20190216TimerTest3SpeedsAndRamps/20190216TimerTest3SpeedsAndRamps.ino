//Timer Interrupt
//Increase variable by 10 every 4 seconds
//Constantly runs the void loop and then executes the 
// interrupt service routine function every 4 seconds
...
volatile unsigned long TimerCounter = 0; // count how many times the timer function is called
...
{  
  ...
  Timer1.initialize(10000000); // 10 million microseconds is 10 seconds
