...
Serial.println("1f"); //Turn the motor at 40% when switched to hardware pins.
delay(20000);  //Delay for stability.
...
Serial.println("4f"); //Turn the motor at 40% when switched to hardware pins.
Serial.println("s");  //Print "s" on serial Monitor for diagnostics.
