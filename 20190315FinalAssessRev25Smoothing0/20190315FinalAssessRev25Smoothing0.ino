...
// NOTE: "S" is now being sent only in the first 3 seconds ***********************************
  ...
  SoftwareSerial mySerial2(10, 11); // RX, TX, Create a softwareSerial port on pins 12 and 13.
...
void setup() 
{
  ...
  for (int thisReading = 0; thisReading < numReadings; thisReading++) //Array for signal smoothing
  {
...
////////////////////////////////////////////////////////////////////////////////////////////
  ...
  ThrottlePercent = ((average / 1023.00) * 100.00); //Analog Input value converted to %.
