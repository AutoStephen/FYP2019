...
if (ThrottlePercent = 50 && ToggleSwitchValue == 1) //if motor is running and switch is off
{
  ThrottlePercent = 50;
  ThrottleString = "5f";
}

if (ThrottlePercent = 50 && ToggleSwitchValue == 0) //if motor is running and switch is off
{
  for(ThrottlePercent = 50 ; ThrottlePercent > 0; ThrottlePercent -=1) 
{
FirstTensVariable = ThrottlePercent; //Store the 0-100 value read from the potentiometer e.g. 58.67%
TensCharacter = (FirstTensVariable/10); //Stroe the tens multiplier e.g. 5
